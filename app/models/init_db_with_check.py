...
def create_pet_species_and_breeds():
    ...
    rodent_breeds = [
        ...
        '기니피그', '친칠라', '네덜란드드워프토끼', '롭이어토끼', '앙고라토끼',
        '페럿', '다람쥐'
    ]
...
def create_speech_styles():
    ...
    speech_styles_data = [
        ...
        (
            ...
            '"걱정 마, 내가 지켜줄게.", "내 옆에 있으면 돼. 내가 다 막아줄게."'
        ),
        (
            '소심한 말투',
            '말끝을 흐리거나 주저하는 표현을 많이 씀. 불안하거나 겁이 많은 듯한 느낌.',
            '"저기… 무서운데… 같이 있어줄래?", "괜찮을까? 나 좀 걱정돼…"'
        ),
        (
            '수다쟁이 말투',
            '말을 끊지 않고 이어가며 감정 과장을 자주 씀. 새로운 주제로 급전환하기도 함.',
